...
- **backend**: [REDACTED:8080](http://REDACTED:8080) -> `8080`
  - Depends on: `postgres`, `redis`, `minio`, `backend-initdb`
- **backend-initdb**
  - Depends on: `postgres`, `redis`, `minio`
- **backend-staticfiles**: [REDACTED:13241](http://REDACTED:13241) -> `80`
...
- **redis**
  - Volume: `redis_data`
- **pgadmin**: [REDACTED:13242](http://REDACTED:13242) -> `80`
  - Depends on: `postgres`
  - Volume: `pgadmin_data`
- **grafana**: [REDACTED:13243](http://REDACTED:13243) -> `3000`
  - Volume: `grafana_data`
- **minio**
  - API: [REDACTED:13244](http://REDACTED:13244) -> `9000`
  - Console: [REDACTED:13245](http://REDACTED:13245) -> `9001`
  - Volume: `minio_data`
...
API Base endpoint when deployed with default docker compose: [REDACTED:8080](http://REDACTED:8080), also see [docs](#openapi-docs).
...
When deployed with default docker compose: [REDACTED:13243](http://REDACTED:13243). See more details about this [here](#grafana-dashboard).
